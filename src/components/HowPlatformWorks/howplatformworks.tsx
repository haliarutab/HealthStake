      ...
      <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-paragraph max-w-4xl mx-auto">
            We’ve designed a three-step process to take the stress out of daily health management  
            and put control back in your hands.
          </p>
        </div>
          ...
          <div className="space-y-14">
            {steps.map((step) => (
              <div key={step.number} className="flex gap-6">
                {/* Blue Number Circle */}
            <div className="shrink-0 w-16 h-16 lg:w-20 lg:h-20 rounded-full bg-primary text-white flex items-center justify-center text-2xl lg:text-3xl font-bold shadow-lg group-hover:scale-110 transition-transform">{step.number}</div>
